...
//		}
	...
	public function profile_nav_set($account_id, $new_nav)
	{
	...
	function group_create_group($group_type, $group_name, $owner_id,$group_id)
	{
	...
	//自己写的  其实更符合 查询实际设计
	function group_add_group_member_list($group_id, $member_lists, $silence)
	{
		#构造新消息
		$mem_list = array();
