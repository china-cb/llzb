...
$.getUrlPage = function(url,pagename) {
...
var table = {
    ...
    turn_tp5_pages:function(url) {
        var page = $.getUrlPage(url,'page');
...
$(function () {
    ...
    ////TP5翻页函数   已经换到get方法的搜索
    //$(document).on("click",'.pagination li a', function () {
    //    var obj = $(this);
    //    var url = obj.attr("href");
    //    //obj.attr("href","#");
    //    //table.turn_tp5_pages(url);
    //
    //})
    //
    //
    ////sousuo
    //$(document).on("click", ".search_new_btn", function () {
    //    var obj = $(this);
    //    if(typeof(obj.data('url')) != "undefined"){
    //        $("#form_content").data("url",obj.data('url'));
    //        alert($("#form_content").attr("url"));
