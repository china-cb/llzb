...
<input type="hidden" id="type_html" value="<?php echo (isset($type) && ($type !== '')?$type:''); ?>">
        ...
        <div class="content">
            <div class="block">
                ...
                <div class="x-current">
                    <p>当前频道图标：</p>
                    <?php if(empty($list['cover']) || ($list['cover'] instanceof \think\Collection && $list['cover']->isEmpty())): ?>
                    <img src="__static__/index/src/img/admin/preview2.png" alt="">
                    <?php else: ?>
                    <img src="<?php echo \think\Config::get('CONFIG_CDN_URL'); ?><?php echo (isset($list['cover']) && ($list['cover'] !== '')?$list['cover']:''); ?>"/>
                    <?php endif; ?>
                    <div style="clear: both"></div>
                     <p>128*128</p>
                </div>
...
<input type="hidden" id="cover_id" value="<?php echo $id; ?>"><!--当前房间ID-->
<input type="hidden" id="map_cover" value=""><!--视频图标值写入-->
<input type="hidden" id="up_cover_url" value="<?php echo url('index/channel_set/up_cover'); ?>"><!--视频图标上传-->
<input type="hidden" id="map_cover_url" value="<?php echo url('index/channel_set/map_cover_list'); ?>"><!--视频图标提交-->
