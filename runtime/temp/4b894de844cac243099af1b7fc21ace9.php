<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"../tpl/admin/finance\use_order_list.html";i:1484634306;s:27:"../tpl/admin/base\base.html";i:1484634306;s:33:"../tpl/admin/base\common_css.html";i:1484634306;s:32:"../tpl/admin/base\common_js.html";i:1484634306;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>  使用订单
...
<div class="mt-20">
    <table class="table table-border table-bordered table-bg table-sort">
        ...
        <tr class="text-c">
            ...
            <td>
                <?php switch($vo['ser_type']): case "1": ?>直播<?php break; case "2": ?>点播<?php break; default: ?>直播
                <?php endswitch; ?>
            </td>
            <td><?php echo (isset($vo['order_id']) && ($vo['order_id'] !== '')?$vo['order_id']:'--'); ?></td>
            <td>￥<?php echo (isset($vo['cost_money']) && ($vo['cost_money'] !== '')?$vo['cost_money']:'--'); ?></td>
            <td>￥<?php echo (isset($vo['balance']) && ($vo['balance'] !== '')?$vo['balance']:'--'); ?></td>
            <td>
