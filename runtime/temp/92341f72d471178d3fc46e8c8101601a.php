<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"../tpl/admin/application\index.html";i:1486436061;s:27:"../tpl/admin/base\base.html";i:1484634306;s:33:"../tpl/admin/base\common_css.html";i:1484634306;s:32:"../tpl/admin/base\common_js.html";i:1486175874;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>  应用场景
...
<div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a class="btn btn-primary radius open_form" data-url="<?php echo url('exec',['type'=>'add']); ?>" href="javascript:;">
        <i class="Hui-iconfont">&#xe600;</i> 添加场景分类</a>
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <?php else: if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr  class="text-c" >
                ...
                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5 open_form" href="javascript:" data-url="<?php echo url('category_child_list',['title'=>$vo['title'],'id'=>$vo['id']]); ?>" title="详情">
                        <i class="Hui-iconfont">&#xe681;</i>
                    </a>
