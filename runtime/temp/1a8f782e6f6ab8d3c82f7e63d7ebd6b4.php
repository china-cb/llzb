            ...
            <div class="block">
                ...
                <div class="guide">
                    <div class="guide_title">
                        直播引导图
                        <span class="on_off
                         <?php switch($list['guide_type']): case "0": ?>guide_on<?php break; case "1": ?>guide_off<?php break; default: ?>guide_off
                         <?php endswitch; ?>
                        ">
                            <i class="
                            <?php switch($list['guide_type']): case "0": ?>off_act<?php break; case "1": break; default: endswitch; ?>
                            "></i>
                        </span>
                    </div>
                    <form id="guide_up">
                    ...
                    <div class="preview3">
                        ...
                        <i class="p_lines"></i>
                        <i class="p_radiu2s"></i>
                        <?php if(empty($list['map_guide']) || ($list['map_guide'] instanceof \think\Collection && $list['map_guide']->isEmpty())): ?>
                        <img class="preview preview3s" src="__static__/index/src/img/admin/preview.png"/>
                        <?php else: ?>
                        <img class="preview preview3s" src="<?php echo \think\Config::get('CONFIG_CDN_URL'); ?><?php echo (isset($list['map_guide']) && ($list['map_guide'] !== '')?$list['map_guide']:''); ?>"/>
                        <?php endif; ?>
                    ...
                    <div class="guide_layer guide_layer2
                            <?php switch($list['guide_type']): case "0": ?>guide_layer2_act<?php break; case "1": break; default: endswitch; ?>
                    "></div>
...
<input type="hidden" id="guide_id" value="<?php echo $id; ?>"><!--当前房间ID-->
<input type="hidden" id="map_guide" value=""><!--引导图值写入-->
<input type="hidden" id="up_guide_url" value="<?php echo url('index/channel_set/up_guide'); ?>"><!--引导图上传-->
<input type="hidden" id="map_guide_url" value="<?php echo url('index/channel_set/map_guide_list'); ?>"><!--引导图提交-->
