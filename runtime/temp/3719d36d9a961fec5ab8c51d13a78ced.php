...
<link rel="stylesheet" type="text/css" href="__static__/index/src/css/control_inner.css" />
                    ...
                    <div class="guide">
                      <form id="window_list">
                        ...
                        <div class="preview3 win_preview3">
                            <?php if(empty($list['window']) || ($list['window'] instanceof \think\Collection && $list['window']->isEmpty())): ?>
                            <img class="preview" src="__static__/index/src/img/admin/win_preview.png"/>
                            <?php else: ?>
                            <img class="preview" src="<?php echo \think\Config::get('CONFIG_CDN_URL'); ?><?php echo (isset($list['window']) && ($list['window'] !== '')?$list['window']:''); ?>"/>
                            <?php endif; ?>
                        </div>
...
<input type="hidden" id="window_id" value="<?php echo $id; ?>"><!--当前房间ID-->
<input type="hidden" id="map_window" value=""><!--窗口背景值写入-->
<input type="hidden" id="up_window_url" value="<?php echo url('index/channel_set/up_window'); ?>"><!--窗口背景上传-->
、<input type="hidden" id="window_url" value="<?php echo url('index/channel_set/up_window_list'); ?>"><!--窗口背景提交-->
