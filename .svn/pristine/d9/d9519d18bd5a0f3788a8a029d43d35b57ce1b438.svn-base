    ...
    function TISClient(container, options) {
        ...
        function SendMessage(body, to, extra) {
            ...
            var obj = {
                ...
                extra: encodeURI(JSON.stringify({user_type:user_type,user_value:user_value}))
            };
        ...
        function loadFlush(){
            ...
            swfobject.embedSWF("http://cdn.aodianyun.com/dms/ROPClient.swf", '__tis__flash__div__', "0", "0", "11.0.0",
                "http://cdn.aodianyun.com/dms/ROPClient.swf", {id:"__tis__"}, {AllowScriptAccess:"always",wmode:"Transparent"},{id:"__tis__",name:"__tis__",align:"middle"},
                callback);
        }
                    ...
                    if (grp.package > 0) {
                        opts.api.getPackage({
                            ...
                            success: function (pkg, opt) {
                                ...
                                var packageUrl = "http://" + opt.userId + ".long-vod.cdn.aodianyun.com/mfs/tis/" + pkg.path + "/";
                                if (pkg.baseUrl) {
